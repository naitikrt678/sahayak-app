...
class MediaService {
  ...
  /// Take photo from camera with optimized settings
  ...
  /// - Max dimension: 800px (reduced from 1280px)
  /// - JPEG format at 50% quality (reduced from 70%)
...
class ImageDimensions {
  ...
  bool get exceedsMaxDimension =>
      width > MediaService.maxDimension || height > MediaService.maxDimension;
